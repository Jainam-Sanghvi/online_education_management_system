...
<section class="liked-videos" id="myTable">
   ...
   <?php
     $query="select l.*,c.*,t.* from tbllike l,tblcontent c,tbltutor t where l.cid=c.cid and c.tutorid=t.id and l.userid='$userid'";
     $result=mysqli_query($con,$query);
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
        <a href="watch_video.php?add=<?php echo $r["cid"]; ?>" class="inline-btn">watch video</a>
         </form>
   </div>
   <?php
            }

...
<section class="playlist-details">
   ...
   <?php
      ...
      <div class="details">
         ...
         <a href="update_playlist.php?update=<?php echo $id; ?>" class="option-btn">update</a>
         <a href="delete_playlist.php?rm=<?php echo $id; ?>" class="delete-btn" onclick="return confirm('delete this playlist?');" >delete</a>

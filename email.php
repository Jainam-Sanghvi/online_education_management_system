   ...
   try {
       ...
       $mail->Body = "
           <div style='font-family: Arial, sans-serif; color: #333; padding: 20px;'>
               <h3>Dear students</h3>
              <p>please <a href='http://localhost:8080/gr74/forgetpassword.php?userid=$userid'>click here</a> to reset your password. This is applicable only for 30 minutes</p>
